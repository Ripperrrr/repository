...
submit_button1 = Button(top, text="choose star image", command=choose_file, font=('Arial 16 bold'),relief=RAISED).grid(row = 0, column = 0,padx=20,pady=20)
submit_button2 = Button(top, text="choose target image", command=choose_file2, font=('Arial 16 bold'),relief=RAISED).grid(row = 0, column = 2,padx=20,pady=20)
...
submit_button3 = Button(top, text="compare", command=comparison,font=('Arial 16 bold'),relief=RAISED).grid(row = 1, column = 1,padx=75,pady=20)
...
enhance_button = Button(top, text = "Enhance", command=enhancement,font=('Arial 16 bold'),relief=RAISED).grid(row = 2, column = 2, pady = 10)
